...
test$microbe1<-ifelse(test$microbe1=="k__Bacteria;p__Proteobacteria;c__Alphaproteobacteria;o__Kiloniellales;f__","order Kiloniellales unknown", test$microbe1)
test$microbe2<-ifelse(test$microbe2=="k__Bacteria;p__Proteobacteria;c__Alphaproteobacteria;o__Kiloniellales;f__","order Kiloniellales unknown",test$microbe2)
