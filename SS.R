...
plot(clp,test_graph_simple,vertex.size=3,vertex.label.cex=1,vertex.color=colrs[V(test_graph)$community],vertex.label.degree=0,edge.label=test$r,edge.widths=test_graph$r,main="C")
